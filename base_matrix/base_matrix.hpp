...
#undef BASE_MATRIX_COMPILED_MATRIX_T_MULTIPLY_MATRIX
#undef BASE_MATRIX_MATRIX_TRANSPOSE_MULTIPLY_VECTOR
#undef BASE_MATRIX_COMPILED_MATRIX_MULTIPLY_TRANSPOSE_MATRIX
#undef BASE_MATRIX_COMPILED_MATRIX_REAL_TO_COMPLEX
#undef BASE_MATRIX_COMPILED_MATRIX_REAL_FROM_COMPLEX
#undef BASE_MATRIX_COMPILED_MATRIX_IMAG_FROM_COMPLEX
